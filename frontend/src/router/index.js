...
const routes = [
  ...
  { path: '/archive', component: () => import('../views/blog/TimelinePage.vue') },
  { path: '/favorites', component: () => import('../views/blog/FavoritesPage.vue'), meta: { requiresAuth: true } },
  ...
  // 个人中心（前台风格，登录用户管理自己的博客）
  {
    ...
    children: [
      ...
      { path: 'favorites', component: () => import('../views/me/Favorites.vue') },
